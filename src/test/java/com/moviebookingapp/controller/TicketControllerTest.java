...
class TicketControllerTest {
	...
	/*
	 * @Test void viewBookedTicketsTest() throws NoTicketBookedException {
	 * when(ticketService.viewBookedTickets("RRR","PVR")).
	 * thenReturn("Number of tickets booked for "+ticket.getMovie().getKey().
	 * getMovieName() +" is "+ticket.getNoOfTickets()); assertEquals(new
	 * ResponseEntity<>("Number of tickets booked for "+ticket.getMovie().getKey().
	 * getMovieName() +" is "+ticket.getNoOfTickets(), HttpStatus.OK),
	 * ticketController.viewBookedTickets("RRR","PVR")); }
	 */
